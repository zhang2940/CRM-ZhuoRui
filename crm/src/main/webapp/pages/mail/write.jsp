...
<!-- 内容主体区域 -->
    ...
    <form id="send" class="layui-form" method="post" enctype="multipart/form-data" action="${pageContext.request.contextPath}/mail/sendmessage.do"
          style="margin-top: 20px;">
        <div class="layui-form-item" >
            <div class="layui-inline" >
                <label class="layui-form-label">接收人：</label>
                <div class="layui-input-inline">
                    <select name="mailfrom" lay-verify="" lay-search>
