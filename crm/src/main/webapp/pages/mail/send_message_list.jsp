...
<!-- 内容主体区域 -->
    <div style="padding: 30px;">
        <table class="layui-table" lay-data="{height:305, url:'/message/ajax/send', page:true,
        id:'test2', skin: 'nob', even: true
        ,request: {
            pageName: 'pageNum',
            limitName: 'pageSize'}
        }" lay-filter="sendTable">
            <thead>
            <tr>
    ...
    layui.use(['laydate', 'laypage', 'layer', 'table', 'carousel', 'upload', 'element'], function () {
        ...
        table.on('tool(sendTable)', function (obj) {
            ...
            if (obj.event === 'del') {
                ...
                window.location.href = '/message/send/readMessage?id=' + data.id;
            }
        });
    });

    function formatMsgStatus(obj) {
        return '<i class="layui-icon layui-icon-release" style="font-size: 30px; color: #1E9FFF;"></i>';
    }
