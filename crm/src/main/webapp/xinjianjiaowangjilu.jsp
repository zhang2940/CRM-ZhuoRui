		...
		<div class="pageTop">
			<div class="page">
				<img src="img/coin02.png" /><span><a id="shou"
					...
					href="jiaowangjl.do?clientId=${xiangxin.clientId}">交往记录</a>&nbsp;- <a
					href="xinjianjiaowangjilu.jsp">新建交往记录</a>&nbsp;- </span>
			</div>
		</div>
		<!-- bbalance 表格 显示 -->
		<div style="position: fixed; top: 200px; left: 200px;" class="conShow">
			<form action="jianjiaowangjl.do" method="get">
				<input type="hidden" name="client_id" value="${xiangxin.clientId}">
				<table border="1" cellspacing="0" cellpadding="0"
					...
					<tr height="110px">
						...
						<td height="80px" width="25%" class="tdColor"><input
							style="width: 200px; height: 50px" type="datetime-local" name="record_date"></td>
						<td style="width: 200px; height: 50px" type="datetime-local"
							class="tdColor">地点</td>
						<td height="80px" width="25%" class="tdColor"><input
							name="record_place" style="width: 200px; height: 50px" value=""
							></td>
					...
					<tr height="110px">
						...
						<td height="80px" width="25%" class="tdColor"><input
							style="width: 200px; height: 50px" type="text" name="record_summary"></td>
						<td style="background-color: #6EC2FE" height="80px" width="25%"
							class="tdColor">备注</td>
						<td height="80px" width="25%" class="tdColor"><input
							style="width: 200px; height: 50px" type="text" value="" name="record_detailed_information"></td>
					</tr>
					<tr height="110px">
						<td style="background-color: #6EC2FE" height="80px" width="25%"
							class="tdColor tdC">详细信息</td>
						<td colspan="2" height="80px" width="25%" class="tdColor">
							<textarea style="resize:none; width: 300px; height: 100px" type="text" name="record_remark" value=""></textarea></td>
						<td height="80px" width="25%"
							class="tdColor"></td>
