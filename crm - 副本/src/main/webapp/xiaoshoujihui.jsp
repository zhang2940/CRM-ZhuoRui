...
<body>
	...
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="img/coin02.png" /><span><a id="shou" onclick="fun()">首页</a>&nbsp;&nbsp;<a
					href="show.do?accountId=${userInfo.accountId}">销售机会管理</a>&nbsp;-</span>
			</div>
		</div>
		...
		<div class="page">
			...
			<a style="position:fixed;left:1150px;top:70px;display:inline-block; width:80px;height:27px; text-decoration:none;text-align:center;line-height:25px; color: white;background-color: #47A4E1" href="chaaccount.do">新建</a>
			<div  class="conform">
					<form action="xiaocha.do" method="post">
						...
						<a style="position: fixed;left:40px;top: 70px">客户名称：</a>
							...
							<input style=" position: fixed;left: 440px;top: 70px" name="summary" value="" type="text" />
						    <a style="position: fixed;left:710px;top: 70px">联系人：</a><input style=" position: fixed;left: 770px;top: 70px" name="contact" type="text" value="" />
				...
				<div style="position:fixed;top:100px;left: 40px;" class="conShow">
					<table border="1" cellspacing="0" cellpadding="0">
						...
						<tr height="85px">
							...
							<td><a href="chaxiuxiao.do?sellId=${showlist.sellId}"><img class="operation"
									src="img/update.png"></a> 
									<a class="zhan"  href="xiaoshan.do?sellId=${showlist.sellId}&accountId=${userInfo.accountId}&biaoshi=${biaoshi}&clientName=${clientName}&summary=${summary}&contact=${contact}&pageNum=${pageInfo.pageNum}"><img 
