		...
		<div class="pageTop">
			<div class="page">
				<img src="img/coin02.png" /><span><a id="shou"
					...
					href="xiugailianxiren.jsp">修改联系人</a>&nbsp;- </span>
			</div>
		</div>
		<!-- bbalance 表格 显示 -->
				...
				<table border="1" cellspacing="0" cellpadding="0"
					...
					<tr height="110px">
						...
						<td height="80px" width="25%" class="tdColor"><input
							style="width: 200px; height: 50px" type="text" name="contactsName" value="${xiugai.contactsName}"></td>
						<td style="background-color: #6EC2FE" height="80px" width="25%"
							class="tdColor">性别</td>
						<td height="80px" width="25%" class="tdColor"><input value="${xiugai.contactsGender}"
							name="contactsGender" style="width: 30px; height: 30px"
							type="radio" value="男" <c:if test='${xiugai.contactsGender.eq(男)}'>checked</c:if>>男<input name="contactsGender"
							style="width: 30px; height: 30px" type="radio" value="女"  <c:if test='${xiugai.contactsGender.eq(女)}'>checked</c:if>>女</td>

					</tr>
					<tr height="110px">
						<td style="background-color: #6EC2FE" height="80px" width="25%"
							class="tdColor tdC">职位</td>
						<td height="80px" width="25%" class="tdColor"><input value=${xiugai.contactsPosition }
							style="width: 200px; height: 50px" type="text" name="contactsPosition"></td>
						<td style="background-color: #6EC2FE" height="80px" width="25%"
							class="tdColor">办公电话</td>
						<td height="80px" width="25%" class="tdColor"><input
							style="width: 200px; height: 50px" type="text" value="" name="contactsOfficeNumber" value="${xiugai.contactsOfficeNumber}"></td>
					</tr>
					<tr height="110px">
						<td style="background-color: #6EC2FE" height="80px" width="25%"
							class="tdColor tdC">手机</td>
						<td height="80px" width="25%" class="tdColor"><input value=${xiugai.contactsPhoneNumber }
							style="width: 200px; height: 50px" type="text" name="contactsPhoneNumber"></td>
						<td style="background-color: #6EC2FE" height="80px" width="25%"
							class="tdColor">备注</td>
						<td height="80px" width="25%" class="tdColor"><input name="contactsRemarks" value=${xiugai.contactsRemarks}
