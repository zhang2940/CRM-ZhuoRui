...
<body>
	...
	<div id="pageAll">
		<div class="pageTop">
			<div class="page">
				<img src="img/coin02.png" /><span><a id="shou"
					...
					&nbsp;&nbsp;<a href="zhiji.do?sellId=${zhiji[0].sellId}">制定计划 </a>&nbsp;</span>
			</div>
		</div>
		...
		<form style="width: 100%; position: fixed; left: 200px; top: 110px"
			...
			<table style="transform: translate(0, 0); width: 60%" border="1"
				...
				<tr><input type="hidden" name="accountId" value="${userInfo.accountId}">
					...
					<td width="25%" class="tdColor"><input  readonly="readonly" type="text" name="opportunitySource"
						value="${zhiji[0].opportunitySource }"></td>

				</tr>
				<tr>
					<td width="25%" class="tdColor tdC">客户名称：</td>
					<td width="25%" class="tdColor"><input  readonly="readonly" type="text"
						required="required" name="customerName" value="${zhiji[0].customerName}"></td>
					<td width="25%" class="tdColor">成功几率：</td>
					<td width="25%" class="tdColor"><input  readonly="readonly" required="required"
						type="text" name="successProbability" value="${zhiji[0].successProbability}"></td>

				</tr>
				<tr>
					<td width="25%" class="tdColor tdC" colspan="1">概要:</td>
					<td width="25%" class="tdColor" colspan="3"><input  readonly="readonly"
						required="required" style="width: 70%; height: 90%; left: 100px"
						type="text" name="summary" value="${zhiji[0].summary}"></td>


				</tr>
				<tr>
					<td width="25%" class="tdColor tdC">联系人：</td>
					<td width="25%" class="tdColor"><input  readonly="readonly" type="text" name="contacts"
						value="${zhiji[0].contacts}"></td>
					<td width="25%" class="tdColor">联系电话：</td>
					<td width="25%" class="tdColor"><input  readonly="readonly" type="text" name="contactsPhone"
						value="${zhiji[0].contactsPhone }"></td>
				</tr>
				<tr>
					<td width="25%" class="tdColor tdC" colspan="1">机会描述：</td>
					<td width="25%" class="tdColor" colspan="3"><textarea  readonly="readonly" name="opportunityDescrible"
				...
				<tr>
					...
					<td width="25%" class="tdColor"><input  readonly="readonly" required="required"
						type="text" name="creator" value="${zhiji[0].creator}"></td>
					<td width="25%" class="tdColor">创建时间：</td>
					<td width="25%" class="tdColor"><input  readonly="readonly" id="chuangjian" required="required"
						type="text" name="creationTime" value="${zhiji[0].creationTime}"></td>

				</tr>
				<tr>
					<td width="25%" class="tdColor tdC">指派人：</td>
					<td width="25%" class="tdColor">
				<input type="text"  readonly="readonly" value="${chaj[0].accountName}"></td>
					<td width="25%" class="tdColor">指派时间：</td>
					<td width="25%" class="tdColor"><input  readonly="readonly" id="zhipai" type="text" name="designatedTime"
						value="${zhiji[0].designatedTime}"></td>
					<div
						style="position: absolute; left: 55%; top: -50px; display: inline-block;">
						<a><a href="zhixingjihua.jsp"
					...
					<div style="position: absolute; left: 48%; top: -50px; display: inline-block;">
						<a
							...
							href="kekai.do?accountId=${userInfo.accountId}&pageNum=1">返回</a>
					</div>
      ...
      <form style="width: 100%; position: fixed; left: 200px; top: 530px" action="jihuaxiang.do">
					<table style="width: 60%;" border="1" cellspacing="0" cellpadding="0">
						<tr >
							<td style="background-color:#4390B9;color: white;" colspan="1" width="25%" class="tdColor">日期</td>
							<td style="background-color:#4390B9;color: white;" colspan="2" width="75%" class="tdColor">计划项</td>
							</tr>
						
					<c:forEach items="${jihuaxiang}" var="jihuaxiang">	<tr height="85px">
					
						<td>${jihuaxiang.planDate}</td>
						<td>${jihuaxiang.planProject}</td>
						<td><a href="shanjihua.do?planId=${jihuaxiang.planId}&sellId=${zhiji[0].sellId }">删除</a></td></tr></c:forEach>
					
						<tr><td colspan="3"><a><input style="float: right;" type="submit" value="保存"></a></td></tr>
						<tr>
						<td colspan="1"> <a>日期：</a>
						<a><input type="datetime-local" name="planDate" value=""></a></td>
						<td colspan="2"><a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;计划项：</a>
					    <a><input  type="text" name="planProject" value=""></a>
						<input type="hidden" name="sellId" value="${zhiji[0].sellId}"></td>
						</tr>
					</table></form>
